...
public class userregister extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profileimg =  findViewById(R.id.userprofileimage);
        r_txtname = (EditText) findViewById(R.id.username);
        r_txtphoneno = (EditText) findViewById(R.id.userphoneno);
        r_txtemail = (EditText) findViewById(R.id.useremail);
        r_txtpassword = (EditText) findViewById(R.id.userpassword);
        r_txtcmpassword = (EditText) findViewById(R.id.usercmpassword);
        btnregister = (Button) findViewById(R.id.userregister);
    ...
    public void Alreadyhaveaccount(View view) {
        Intent intent = new Intent(userregister.this,sendmessage.class);
    ...
    private void inputdata() {
        ...
        {
            r_txtname.setError("Please Enter Your Name");
            Toast.makeText(this,"Enter Name",Toast.LENGTH_SHORT).show();
            return;
        }
        if(TextUtils.isEmpty(phoneno))
        {
            r_txtphoneno.setError("Please Enter Phone No.");
            Toast.makeText(this,"Enter Phone number",Toast.LENGTH_SHORT).show();
            return;
        }
        if(!Patterns.EMAIL_ADDRESS.matcher(emailrt).matches())
        {
            r_txtemail.setError("Please Enter Your Email: example@gmail.com");
            Toast.makeText(this,"Enter Email",Toast.LENGTH_SHORT).show();
            return;
        }
        if(password.length()>6)
        {
            r_txtpassword.setError("Please Enter Password More Then 6 Characters");
        ...
        {
            r_txtcmpassword.setError("Please Enter Confirm Password");
        ...
        if(image_uri==null)
        {
            ...
            ref.child(firebaseauth.getUid()).setValue(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                ...
                public void onSuccess(Void unused) {
                    progressDialog.dismiss();
                    startActivity(new Intent(userregister.this,userview.class));
                    finish();
                }
            }).addOnFailureListener(new OnFailureListener() {
                @Override
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    if(uriTask.isSuccessful()) {
                        ...
                        ref.child(firebaseauth.getUid()).setValue(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void unused) {
                                progressDialog.dismiss();
                                startActivity(new Intent(userregister.this, mainseller.class));
                                finish();
                            }
                        }).addOnFailureListener(new OnFailureListener() {
                            @Override
    ...
    public void ShowHidePass(View view) {
        ...
        if(view.getId()==R.id.show_pass_btn){
            if(r_txtpassword.getTransformationMethod().equals(PasswordTransformationMethod.getInstance())){
                ((ImageView)(view)).setImageResource(R.drawable.ic_baseline_visibility_off_24);
                //Show Password
                r_txtpassword.setTransformationMethod(HideReturnsTransformationMethod.getInstance());
            }
            else{
                ((ImageView)(view)).setImageResource(R.drawable.ic_baseline_visibility_24);
                //Hide Password
                r_txtpassword.setTransformationMethod(PasswordTransformationMethod.getInstance());
            }
        }
