...
public class phonecall extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtemail = (EditText) findViewById(R.id.phoneno);
    ...
    private void loginuser() {
        ...
        {
            txtemail.setError("Phone Number Is Not Empty");
            Toast.makeText(this,"Invalid Number pattern ...........",Toast.LENGTH_SHORT).show();
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        for (DataSnapshot ds: snapshot.getChildren())
                        {
                            ...
                            {
                                startActivity(new Intent(phonecall.this,userview.class));
                            ...
                            {
                                startActivity(new Intent(phonecall.this,mainseller.class));
                                finish();
                            }
                        }
                    }
    ...
    public void createnewaccount(View view) {
        Intent intent = new Intent(phonecall.this,Sellerregister.class);
